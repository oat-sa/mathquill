...
var BottomNotation = P(MathCommand, function (_, super_){
  _.init = function (ch, html) {
    var htmlTemplate =
        '<span class="mq-regular-operator mq-non-leaf">'
        +   '<span>'+html+'</span>'
        +   '<span class="mq-from">&0</span>'
        + '</span>'
    ;
...
LatexCmds.lim = bind(BottomNotation, '\\lim', 'lim');
